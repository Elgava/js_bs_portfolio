...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "take the drink or go to sleep";
            break;
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (answers[3] === "TAKE THE DRINK") {
                story.innerHTML = document.getElementById("answer70").innerHTML;
                askQuestion(3);
            } else if (answers[3] === "GO TO SLEEP") {
                story.innerHTML = document.getElementById("answer12").innerHTML;
                askQuestion(3);
            } else {
